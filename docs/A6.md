...
1. Visualizar la distribución espacial de los incidentes históricos de incendios y las estaciones de bomberos.  
   ...
   ![Figura 1 - Visualización de mapa (zoom out)](assets/images/A6_fig01_mapa_zoomout.png)
   ![Figura 2 - Visualización de mapa (zoom in)](assets/images/A6_fig02_mapa_zoomin.png) 
   ...
   ![Figura 3 - Visualización de mapa (mobile)](assets/images/A6_fig03_mapa_mobile.png)  
   ![Figura 4 - Controles de mapa expandido](assets/images/A6_fig04_controles_mapa.png)

3. Consultar los detalles de un incidente específico.  
   ...
   ![Figura 5 - Resumen incidente](assets/images/A6_fig05_resumen_incidente.png)
   ...
   ![Figura 6 - Detalle incidente](assets/images/A6_fig06_detalle_incidente.png)

4. Filtrar los datos según criterios básicos.  
   ...
   ![Figura 7 - Filtro administrador](assets/images/A6_fig07_filtro_admin.png)
   ...
   ![Figura 8 - Filtro invitado](assets/images/A6_fig08_filtro_invitado.png)
...
5. Visualizar datos históricos en formato de tabla.  
   ...
   ![Figura 9 - Vista tabla](assets/images/A6_fig09_vista_tabla.png)
...
- **Módulo Strategic (Análisis Avanzado)**: Modelos predictivos, análisis de zonas críticas y cálculos de tiempos de respuesta. Se encuentra en fase preliminar.
  ...
  ![Figura 10 - Módulo Strategic (parte 1)](assets/images/A6_fig10_strategic_1.png)  
  ![Figura 11 - Módulo Strategic (parte 2)](assets/images/A6_fig11_strategic_2.png)
...
- **Módulo Dashboard**: Vista inicial con indicadores clave como la cantidad de incidentes recientes o la distribución de la severidad (ej. gráfico de barras o circular). Se encuentra en fase preliminar.
  ...
  ![Figura 12 - Módulo Dashboard](assets/images/A6_fig12_dashboard.png)
