...
### 1. Visualizar la distribución espacial de los incidentes históricos de incendios y las estaciones de bomberos.  
   ...
   <figure style="text-align:center;">
     <img src="assets/images/A6_fig01_mapa_zoomout.png" alt="Visualización de mapa (zoom out)"/>
     <figcaption>Figura 1 – Visualización de mapa (zoom out)</figcaption>
   </figure>

   <figure style="text-align:center;">
     <img src="assets/images/A6_fig02_mapa_zoomin.png" alt="Visualización de mapa (zoom in)"/>
     <figcaption>Figura 2 – Visualización de mapa (zoom in)</figcaption>
   </figure>
   ...
   <figure style="text-align:center;">
     <img src="assets/images/A6_fig03_mapa_mobile.png" alt="Visualización de mapa (mobile)"/>
     <figcaption>Figura 3 – Visualización de mapa (mobile)</figcaption>
   </figure>

   <figure style="text-align:center;">
     <img src="assets/images/A6_fig04_controles_mapa.png" alt="Controles de mapa expandido"/>
     <figcaption>Figura 4 – Controles de mapa expandido</figcaption>
   </figure>
...
### 2. Consultar los detalles de un incidente específico.  
   ...
   <figure style="text-align:center;">
     <img src="assets/images/A6_fig05_resumen_incidente.png" alt="Resumen incidente"/>
     <figcaption>Figura 5 – Resumen incidente</figcaption>
   </figure>
   ...
   <figure style="text-align:center;">
     <img src="assets/images/A6_fig06_detalle_incidente.png" alt="Detalle incidente"/>
     <figcaption>Figura 6 – Detalle incidente</figcaption>
   </figure>
...
### 3. Filtrar los datos según criterios básicos.  
   ...
   <figure style="text-align:center;">
     <img src="assets/images/A6_fig07_filtro_admin.png" alt="Filtro administrador"/>
     <figcaption>Figura 7 – Filtro administrador</figcaption>
   </figure>
   ...
   <figure style="text-align:center;">
     <img src="assets/images/A6_fig08_filtro_invitado.png" alt="Filtro invitado"/>
     <figcaption>Figura 8 – Filtro invitado</figcaption>
   </figure>
...
### 4. Visualizar datos históricos en formato de tabla.  
   ...
   <figure style="text-align:center;">
     <img src="assets/images/A6_fig09_vista_tabla.png" alt="Vista tabla"/>
     <figcaption>Figura 9 – Vista tabla</figcaption>
   </figure>
...
- **Módulo Strategic (Análisis Avanzado)**: Modelos predictivos, análisis de zonas críticas y cálculos de tiempos de respuesta. Se encuentra en fase preliminar.
  ...
  <figure style="text-align:center;">
    <img src="assets/images/A6_fig10_strategic_1.png" alt="Módulo Strategic (parte 1)"/>
    <figcaption>Figura 10 – Módulo Strategic (parte 1)</figcaption>
  </figure>

  <figure style="text-align:center;">
    <img src="assets/images/A6_fig11_strategic_2.png" alt="Módulo Strategic (parte 2)"/>
    <figcaption>Figura 11 – Módulo Strategic (parte 2)</figcaption>
  </figure>
...
- **Módulo Dashboard**: Vista inicial con indicadores clave como la cantidad de incidentes recientes o la distribución de la severidad (ej. gráfico de barras o circular). Se encuentra en fase preliminar.
  ...
  <figure style="text-align:center;">
    <img src="assets/images/A6_fig12_dashboard.png" alt="Módulo Dashboard"/>
    <figcaption>Figura 12 – Módulo Dashboard</figcaption>
  </figure>
